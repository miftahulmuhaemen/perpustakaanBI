<div class="mb-4">
	<div class="container">
		<form class action="<?php echo base_url('kelola-user') ?>" method="get">
	...
	<div class="kelolaUser rounded-lg px-3 pb-2 container">
		...
		<div class="row user-view rounded-lg mb-4 d-flex align-items-center mb-3">
			...
			<div class="col-lg-2 text-right">
				<a href="<?php echo base_url('edit/user?uid='.encrypt_url($value->Id)) ?>" class="btn btn-edit rgba-blue-strong p-2"><i class="far fa-edit"></i> Edit</a>
			</div>
