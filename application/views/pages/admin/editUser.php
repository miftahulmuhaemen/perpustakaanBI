...
<div class="container py-5 card mb-4 rounded-lg" style="padding:1.5rem!important">
	<div class="row">
		<ul class="nav justify-content-end w-100">
			<li class="nav-item">
				<a class="nav-link btn btn-danger p-2 " onclick="goBack()" type="button"> <i class="fas fa-angle-left white-text"></i> <span class="white-text">Kembali</span></a>
			</li>
		</ul>
	</div>
	<h4 class="card-title mx-auto my-5"><strong>Update Data Pengguna</strong></h4>
	<!--Section: Content-->
	<section class="px-md-5 mx-md-5 text-left dark-grey-text">

		<div class="">
			<div class="col-sm-12">
				<form action="<?php echo base_url('admin/updateUser?id='.$this->input->get('uid')) ?>" method="post">
