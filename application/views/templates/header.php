                ...
                <?php echo strtoupper($title) ?>
					...
					<ul class="navbar-nav ml-auto nav-flex-icons mr-5">
						<li class="nav-item avatar dropdown">
							<a class="nav-link" id="dropdown" data-toggle="dropdown" href="#sidebarUser" aria-expanded="false" aria-controls="collapseExample">
								<i class="blue-grey-text fas fa-3x fa-user-circle"></i>
							</a>
							<div class="dropdown-menu dropdown-menu-lg-right dropdown-dark" aria-labelledby="navbarDropdownMenuLink-55">
								<?php if ($this->session->userdata('level')==5): ?>
									<a class="dropdown-item"  href="<?php echo base_url('user/profile') ?>"><?php echo $this->session->userdata('nama') ?></a>
								<?php endif; ?>
									<a class="dropdown-item" href="<?php echo base_url('user/edit'); ?>">Atur Akun</a>
									<a class="dropdown-item" href="<?php echo base_url('logout') ?>">Log out</a>
							</div>
						</li>
					</ul>
